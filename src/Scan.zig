...
pub const have_posix_stat = zdu.have_posix_stat;
pub const PosixStat = zdu.PosixStat;

pub const posixStatIsRegular = zdu.posixStatIsRegular;
pub const posixStatIsDirectory = zdu.posixStatIsDirectory;
pub const posixStatApparentSize = zdu.posixStatApparentSize;
pub const posixStatAllocatedSize = zdu.posixStatAllocatedSize;

pub const cStatAt = zdu.cStatAt;
pub const fileSizeOnDiskAt = zdu.fileSizeOnDiskAt;
pub const fileSizeOnDiskWithLibcAt = zdu.fileSizeOnDiskWithLibcAt;
pub const fileSizeOnDiskFallbackAt = zdu.fileSizeOnDiskFallbackAt;
...
pub const isGeneratedDirPath = zdu.isGeneratedDirPath;
pub const pathNeedsGeneratedDirChecks = zdu.pathNeedsGeneratedDirChecks;
